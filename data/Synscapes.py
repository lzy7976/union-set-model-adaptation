...
class Synscapes(data.Dataset):
    ...
    def _get_samples(self):
        self.sample_dicts = []
        img_list = os.listdir(os.path.join(self.data_dir, 'Synscapes', 'img', 'rgb'))
        for img in img_list:
            sample_dict = {
                'image': os.path.join(self.data_dir, 'Synscapes', 'img', 'rgb', img),
                'label': os.path.join(self.data_dir, 'Synscapes', 'img', 'class', img),
            }
